...
// -----------------------------------------------------------------------------
	 ...
	 * @param $pos (int) current_choice position
	 * @param $mode (int) current_choice encoding mode
	 ...
	 * @param $numcw (int) Number of current_choice codewords.
	...
	protected function getHighLevelEncoding($data) {
		...
		$enc = ENC_ASCII; // current_choice encoding mode
		$pos = 0; // current_choice position
		...
		while ($pos < $data_length) {
			...
			switch ($enc) {
				...
				case ENC_X12 : { // ANSI X12
					...
					// get basic charset for current_choice encoding
