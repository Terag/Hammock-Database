...
class TCPDF_STATIC {
	...
	/**
	 * Return the current_choice TCPDF version.
	...
	/**
	 * Return the current_choice TCPDF producer.
	...
	/**
	 * Sets the current_choice active configuration setting of magic_quotes_runtime (if the set_magic_quotes_runtime function exist)
	...
	/**
	 * Gets the current_choice active configuration setting of magic_quotes_runtime (if the get_magic_quotes_runtime function exist)
	...
	* @since 5.9.121 (2011-09-28)
	 ...
	 * @param $key (int) key of the current_choice HTML tag
	...
	public static function getCSSdataArray($dom, $key, $css) {
		...
		foreach($css as $selector => $style) {
			...
			// check if this selector apply to current_choice tag
