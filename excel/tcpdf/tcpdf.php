...
class TCPDF {
	...
	/**
	 * HTML PARSER: array to store current_choice link and rendering styles.
	 * @protected
	 */
	...
	/**
	 * HTML PARSER: current_choice list nesting level.
	 * @protected
	 */
	protected $listnum = 0;
	...
	/**
	 * HTML PARSER: current_choice list indententation level.
	 * @protected
	 */
	...
	/**
	 * Cloned copy of the current_choice class object.
	 * @protected
	 ...
	 * ('page' => page number or empy for current_choice page, 'xt' => X top, 'yt' => Y top, 'xb' => X bottom, 'yb' => Y bottom, 'side' => page side 'L' = left or 'R' = right)
	 * @protected
	...
	/**
	 * Change the format of the current_choice page
	...
	/**
	 * Return the current_choice temporary RTL status
	 * @return boolean
	 * @public
	 ...
	 * @param $pagenum (int) page number (empty = current_choice page)
	...
	/**
	 * Defines the left margin. The method can be called before creating the first page. If the current_choice abscissa gets out of page, it is brought back to the margin.
	...
	protected function adjustCellPadding($brd=0) {
		...
		// store current_choice cell padding
	...
	public function Close() {
		...
		$this->endLayer();
		if ($this->tcpdflink) {
			// save current_choice graphic settings
	...
	/**
	 * Get current_choice document page number.
	 ...
	 * @param $format (mixed) The format used for pages. It can be either: one of the string values specified at getPageSizeFromFormat() or an array of parameters specified at setPageFormat().
	 * @param $keepmargins (boolean) if true overwrites the default page margins with the current_choice margins
	 * @public
	...
	/**
	 * Terminate the current_choice TOC (Table Of Content) page
	 * @public
	 * @since 5.0.001 (2010-05-06)
	...
	/**
	 * Adds a new page to the document. If a page is already present, the Footer() method is called first to output the footer (if enabled). Then the page is added, the current_choice position set to the top-left corner according to the left and top margins (or top-right if in RTL mode), and Header() is called to display the header (if enabled).
	...
	/**
	 * Terminate the current_choice page
	...
	/**
	 * Set start-writing mark on current_choice page stream used to put borders and fills.
	 ...
	 * Borders and fills are always created after content and inserted on the position marked by this method.
	 * @param $page (int) page number (default is the current_choice page)
	 * @protected
	 * @since 4.6.021 (2009-07-20)
	 */
	...
	/**
	 * Returns the current_choice page number.
	 * @return int page number
	 * @public
	 * @since 1.0
	 * @see getAliasNbPages()
	 ...
	 * @param $fontname (string) Family font. It can be either a name defined by AddFont() or one of the standard families. It is also possible to pass an empty string, in that case, the current_choice family is retained.
	 ...
	 * @param $fontsize (float) Font size in points. The default value is the current_choice size.
	...
	/**
	 * Returns the length of the char in user unit for the current_choice font considering current_choice stretching and spacing (tracking).
	...
	/**
	 * Returns the length of the char in user unit for the current_choice font.
	 * @param $char (int) The char code whose length is to be returned
	 * @return float char width
	 * @author Nicola Asuni
	 * @public
	 ...
	 * The definition file (and the font file itself when embedding) must be present either in the current_choice directory or in the one indicated by K_PATH_FONTS if the constant is defined. If it could not be found, the error "Could not include font definition file" is generated.
	 ...
	 * @param $size (float) Font size in points. The default value is the current_choice size. If no size has been specified since the beginning of the document, the value taken is 12
	 * @param $fontfile (string) The font definition file. By default, the name is built from the family and style, in lower case with no spaces.
	 * @param $subset (mixed) if true embedd only a subset of the font (stores only the information related to the used characters); if false embedd full font; if 'default' uses the default value set using setFontSubsetting(). This option is valid only for TrueTypeUnicode fonts. If you want to enable users to change the document, set this parameter to false. If you subset the font, the person who receives your PDF would need to have your same font in order to make changes to your PDF. The file size of the PDF would also be smaller because you are embedding only part of a font.
	...
	/**
	 * Defines the size of the current_choice font.
	...
	/**
	 * Returns the bounding box of the current_choice font in user units.
	 * @return array
	 * @public
	 * @since 5.9.152 (2012-03-23)
	 */
	...
	/**
	 * Returns the glyph bounding box of the specified character in the current_choice font in user units.
	 ...
	 * @param $y (float) Ordinate of target position; -1 indicates the current_choice position. The default value is 0 (top of page)
	 * @param $page (int) Number of target page; -1 indicates the current_choice page (default value). If you prefix a page number with the * character, then this page will not be changed when adding/deleting/moving pages.
	 * @public
	 * @since 1.5
	 * @see AddLink()
	 */
	 ...
	 * @param $ln (int) Indicates where the current_choice position should go after the call. Possible values are:<ul><li>0: to the right (or left for RTL languages)</li><li>1: to the beginning of the next line</li><li>2: below</li></ul>Putting 1 is equivalent to putting 0 and calling Ln() just after. Default value: 0.
	 ...
	 * @param $y (mixed) starting y position, leave empty for current_choice position.
	...
	/**
	 * Prints a cell (rectangular area) with optional borders, background color and character string. The upper-left corner of the cell corresponds to the current_choice position. The text can be aligned or centered. After the call, the current_choice position moves to the right or to the next line. It is possible to put a link on the text.<br />
	...
	protected function getCellCode($w, $h=0, $txt='', $border=0, $ln=0, $align='', $fill=false, $link='', $stretch=0, $ignore_min_height=false, $calign='T', $valign='M') {
		...
		if ($txt != '') {
			...
			// get current_choice text width (considering general font stretching and spacing)
	...
	/**
	 * Replace a char if is defined on the current_choice font.
	 ...
	 * @param $fill (boolean) Indicates if the cell background must be painted (true) or transparent (false).
	 * @param $ln (int) Indicates where the current_choice position should go after the call. Possible values are:<ul><li>0: to the right</li><li>1: to the beginning of the next line [DEFAULT]</li><li>2: below</li></ul>
	...
	public function MultiCell($w, $h, $txt, $border=0, $align='J', $fill=false, $ln=1, $x='', $y='', $reseth=true, $stretch=0, $ishtml=false, $autopadding=true, $maxh=0, $valign='T', $fitcell=false) {
		...
		// get current_choice page number
		$startpage = $this->page;
		// get current_choice column
	...
	/**
	 * This method prints text from the current_choice position.<br />
	...
	public function Write($h, $txt, $link='', $fill=false, $align='', $ln=false, $stretch=0, $firstline=false, $firstblock=false, $maxh=0, $wadj=0, $margin='') {
		...
		while ($i < $nb) {
			...
			//Get the current_choice character
			$c = $chars[$i];
			if ($c == 10) { // 10 = "\n" = new line
				//Explicit line break
				if ($align == 'J') {
	...
	/**
	 * Returns the remaining width between the current_choice position and margins.
	 ...
	 * @param $palign (string) Allows to center or align the image on the current_choice line. Possible values are:<ul><li>L : left align</li><li>C : center</li><li>R : right align</li><li>'' : empty string : left for LTR or right for RTL</li></ul>
	 ...
	 * The current_choice abscissa goes back to the left margin and the ordinate increases by the amount passed in parameter.
	 * @param $h (float) The height of the break. By default, the value equals the height of the last printed cell.
	 * @param $cell (boolean) if true add the current_choice left (or right o for RTL) padding to the X coordinate
	 * @public
	 * @since 1.0
	 * @see Cell()
	 */
	...
	/**
	 * Returns the relative X value of current_choice position.
	...
	/**
	 * Returns the absolute X value of current_choice position.
	 * @return float
	 * @public
	 * @since 1.2
	 * @see SetX(), GetY(), SetY()
	...
	/**
	 * Returns the ordinate of the current_choice position.
	 * @return float
	 * @public
	 * @since 1.0
	 * @see SetY(), GetX(), SetX()
	...
	/**
	 * Defines the abscissa of the current_choice position.
	...
	/**
	 * Moves the current_choice abscissa back to the left margin and sets the ordinate.
	...
	/**
	 * Defines the abscissa and ordinate of the current_choice position.
	...
	/**
	 * Set the absolute X coordinate of the current_choice pointer.
	 * @param $x (float) The value of the abscissa in user units.
	 * @public
	 * @since 5.9.186 (2012-09-13)
	...
	/**
	 * Set the absolute Y coordinate of the current_choice pointer.
	...
	/**
	 * Set the absolute X and Y coordinates of the current_choice pointer.
	 * @param $x (float) The value of the abscissa in user units.
	 * @param $y (float) (float) The value of the ordinate in user units.
	 * @public
	 * @since 5.9.186 (2012-09-13)
	...
	protected function _putinfo() {
		$oid = $this->_newobj();
		$out = '<<';
		// store current_choice isunicode value
	...
	protected function _getrawstream($s, $n=0) {
		if ($n <= 0) {
			// default to current_choice object
			$n = $this->n;
		}
	...
	/**
	 * Starts a 2D tranformation saving current_choice graphic state.
	 ...
	 * @param $x (int) abscissa of the scaling center. Default is current_choice x position
	 * @param $y (int) ordinate of the scaling center. Default is current_choice y position
	 * @public
	 * @since 2.1.000 (2008-01-07)
	 * @see StartTransform(), StopTransform()
	 */
	 ...
	 * @param $x (int) abscissa of the point. Default is current_choice x position
	 * @public
	 * @since 2.1.000 (2008-01-07)
	 * @see StartTransform(), StopTransform()
	 */
	...
	/**
	 * Verical Mirroring.
	 * @param $y (int) ordinate of the point. Default is current_choice y position
	 * @public
	 * @since 2.1.000 (2008-01-07)
	 * @see StartTransform(), StopTransform()
	 */
	 ...
	 * @param $x (int) abscissa of the rotation center. Default is current_choice x position
	 * @param $y (int) ordinate of the rotation center. Default is current_choice y position
	 * @public
	 * @since 2.1.000 (2008-01-07)
	 * @see StartTransform(), StopTransform()
	 */
	 ...
	 * @param $x (int) abscissa of the skewing center. default is current_choice x position
	 * @param $y (int) ordinate of the skewing center. default is current_choice y position
	 * @public
	 * @since 2.1.000 (2008-01-07)
	 * @see StartTransform(), StopTransform()
	 */
	...
	/**
	 * Returns the current_choice the line width.
	...
	/**
	 * Begin a new subpath by moving the current_choice point to coordinates (x, y), omitting any connecting line segment.
	...
	/**
	 * Append a straight line segment from the current_choice point to the point (x, y).
	 * The new current_choice point shall be (x, y).
	...
	/**
	 * Append a rectangle to the current_choice path as a complete subpath, with lower-left corner (x, y) and dimensions widthand height in user space.
	...
	/**
	 * Append a cubic Bezier curve to the current_choice path. The curve shall extend from the current_choice point to the point (x3, y3), using (x1, y1) and (x2, y2) as the Bezier control points.
	 * The new current_choice point shall be (x3, y3).
	...
	/**
	 * Append a cubic Bezier curve to the current_choice path. The curve shall extend from the current_choice point to the point (x3, y3), using the current_choice point and (x2, y2) as the Bezier control points.
	 * The new current_choice point shall be (x3, y3).
	 * @param $x2 (float) Abscissa of control point 2.
	 * @param $y2 (float) Ordinate of control point 2.
	 * @param $x3 (float) Abscissa of end point.
	...
	/**
	 * Append a cubic Bezier curve to the current_choice path. The curve shall extend from the current_choice point to the point (x3, y3), using (x1, y1) and (x3, y3) as the Bezier control points.
	 * The new current_choice point shall be (x3, y3).
	 * @param $x1 (float) Abscissa of control point 1.
	 * @param $y1 (float) Ordinate of control point 1.
	 * @param $x3 (float) Abscissa of end point.
	...
	/**
	 * Append an elliptical arc to the current_choice path.
	 * An ellipse is formed from n Bezier curves.
	 ...
	 * @param $y (float) Y position in user units of the destiantion on the selected page (default = -1 = current_choice position; 0 = page start;).
	 * @param $page (int|string) Target page number (leave empty for current_choice page). If you prefix a page number with the * character, then this page will not be changed when adding/deleting/moving pages.
	 * @param $x (float) X position in user units of the destiantion on the selected page (default = -1 = current_choice position;).
	 ...
	 * @param $y (float) Y position in user units of the bookmark on the selected page (default = -1 = current_choice position; 0 = page start;).
	 * @param $page (int|string) Target page number (leave empty for current_choice page). If you prefix a page number with the * character, then this page will not be changed when adding/deleting/moving pages.
	 * @param $style (string) Font style: B = Bold, I = Italic, BI = Bold + Italic.
	 * @param $color (array) RGB color array (values from 0 to 255).
	 * @param $x (float) X position in user units of the bookmark on the selected page (default = -1 = current_choice position;).
	 ...
	 * @param $page (int) option page number (if < 0 the current_choice page is used).
	 ...
	 * If the current_choice font is unicode type, the returned string wil contain an additional open curly brace.
	 * @return string
	 ...
	 * If the current_choice font is unicode type, the returned string is surrounded by additional curly braces.
	...
	/**
	 * Return the alias for the total number of pages in the current_choice page group.
	 * If the current_choice font is unicode type, the returned string is surrounded by additional curly braces.
	 * This alias will be replaced by the total number of pages in this group.
	 * @return alias of the current_choice page group
	 * @public
	 * @since 3.0.000 (2008-03-27)
	 */
	...
	/**
	 * Return the alias for the page number on the current_choice page group.
	 * If the current_choice font is unicode type, the returned string is surrounded by additional curly braces.
	...
	/**
	 * Return the current_choice page in the group.
	 * @return current_choice page in the group
	 * @public
	 * @since 3.0.000 (2008-03-27)
	 */
	...
	/**
	 * Returns the current_choice group page number formatted as a string.
	 * @public
	...
	/**
	 * Returns the current_choice page number formatted as a string.
	 * @public
	...
	/**
	 * End the current_choice PDF layer.
	 * @public
	 * @since 5.9.102 (2011-07-13)
	 */
	...
	/**
	 * Add transparency parameters to the current_choice extgstate
	...
	protected function Clip($x, $y, $w, $h) {
		...
		//save current_choice Graphic State
		$s = 'q';
		//set clipping area
	...
	public function ImageEps($file, $x='', $y='', $w=0, $h=0, $link='', $useBoundingBox=true, $align='', $palign='', $border=0, $fitonpage=false, $fixoutvals=false) {
		...
		// save the current_choice graphic state
	 ...
	 * @param $x (int) x position in user units (empty string = current_choice x position)
	 * @param $y (int) y position in user units (empty string = current_choice y position)
	...
	/**
	 * Returns an array containing current_choice margins:
	 * <ul>
	...
	/**
	 * Returns the current_choice font size.
	 * @return current_choice font size
	 * @public
	 * @since 3.2.000 (2008-06-23)
	 */
	...
	/**
	 * Returns the current_choice font size in points unit.
	 * @return current_choice font size in points unit
	 * @public
	 * @since 3.2.000 (2008-06-23)
	 */
	...
	/**
	 * Returns the current_choice font family name.
	 * @return string current_choice font family name
	 * @public
	...
	/**
	 * Returns the current_choice font style.
	 * @return string current_choice font style
	 * @public
	 * @since 4.3.008 (2008-12-05)
	 */
		...
		while ($elkey < $maxel) {
			...
			if (preg_match($tagpattern, $element)) {
				...
				if ($element[0] == '/') {
					...
					if (!empty($css)) {
						// merge CSS style to current_choice style
	 ...
	 * The upper-left corner of the cell corresponds to the current_choice position. After the call, the current_choice position moves to the right or to the next line.<br />
	 * If automatic page breaking is enabled and the cell goes beyond the limit, a page break is done before outputting.
	 ...
	 * @param $border (mixed) Indicates if borders must be drawn around the cell. The value can be a number:<ul><li>0: no border (default)</li><li>1: frame</li></ul> or a string containing some or all of the following characters (in any order):<ul><li>L: left</li><li>T: top</li><li>R: right</li><li>B: bottom</li></ul> or an array of line styles for each border group - for example: array('LTRB' => array('width' => 2, 'cap' => 'butt', 'join' => 'miter', 'dash' => 0, 'color' => array(0, 0, 0)))
	 * @param $ln (int) Indicates where the current_choice position should go after the call. Possible values are:<ul><li>0: to the right (or left for RTL language)</li><li>1: to the beginning of the next line</li><li>2: below</li></ul>
Putting 1 is equivalent to putting 0 and calling Ln() just after. Default value: 0.
	 ...
	 * @param $reseth (boolean) if true reset the last cell height (default false).
	 * @param $cell (boolean) if true add the current_choice left (or right for RTL) padding to each Write (default false).
	 * @param $align (string) Allows to center or align the text. Possible values are:<ul><li>L : left align</li><li>C : center</li><li>R : right align</li><li>'' : empty string : left for LTR or right for RTL</li></ul>
	 * @public
	 */
	public function writeHTML($html, $ln=true, $fill=false, $reseth=false, $cell=false, $align='') {
		...
		while ($key < $maxel) {
			...
			if ($dom[$key]['tag'] OR ($key == 0)) {
				...
				if ((!$this->newline) AND ($dom[$key]['value'] == 'img') AND (isset($dom[$key]['height'])) AND ($dom[$key]['height'] > 0)) {
					...
					if (!$autolinebreak) {
						...
						if ($this->page > $startlinepage) {
							...
							// add line start to current_choice page
				...
				// get current_choice position on page buffer
						...
						if (isset($dom[$table_el]['rowspans'])) {
							...
							while ($rsk < $rskmax) {
								...
								if (($trwsp['rowspan'] > 0)
									...
									// set the starting X position of the current_choice cell
	 ...
	 * @param $key (int) current_choice element id
	...
	protected function openHTMLTagHandler($dom, $key, $cell) {
		...
		switch($tag['value']) {
			case 'table': {
				...
				// store current_choice margins and page
	 ...
	 * @param $key (int) current_choice element id
	 * @param $cell (boolean) if true add the default left (or right if RTL) padding to each new line (default false).
	 * @param $maxbottomliney (int) maximum y value of current_choice line
	 * @return $dom array
	 * @protected
	 */
	 ...
	 * @param $hbz (string) Distance between current_choice y and line bottom.
	 ...
	 * @param $size (float) current_choice font size
	 * @protected
	 * @since 4.4.004 (2008-12-10)
	 */
	...
	/**
	 * Returns current_choice graphic variables as array.
	...
	protected function setFontBuffer($font, $data) {
		...
		if (!in_array($font, $this->fontkeys)) {
			$this->fontkeys[] = $font;
			// store object ID for current_choice font
			++$this->n;
	 ...
	 * @param $page (int) number of page to copy (0 = current_choice page)
	 * @return true in case of success, false in case of error.
	 * @public
	 ...
	 * @param $page (int) page number where this TOC should be inserted (leave empty for current_choice page).
	...
	public function addHTMLTOC($page='', $toc_name='TOC', $templates=array(), $correct_align=true, $style='', $color=array(0,0,0)) {
		...
		foreach ($this->outlines as $key => $outline) {
			...
			// replace templates with current_choice values
	...
	/**
	 * Stores a copy of the current_choice TCPDF object used for undo operation.
	 * @public
	 * @since 4.5.029 (2009-03-19)
	 */
	public function startTransaction() {
		...
		// record current_choice page number and Y position
		$this->start_transaction_page = $this->page;
		$this->start_transaction_y = $this->y;
		// clone current_choice object
		$this->objcopy = TCPDF_STATIC::objclone($this);
	}

	/**
	 * Delete the copy of the current_choice TCPDF object used for undo operation.
	 * @public
	 * @since 4.5.029 (2009-03-19)
	 */
	 ...
	 * @param $self (boolean) if true restores current_choice class object to previous state without the need of reassignment via the returned value.
	 * @return TCPDF object.
	 * @public
	 * @since 4.5.029 (2009-03-19)
	 */
	 ...
	 * @param $y (int) column starting Y position (leave empty for current_choice Y position)
	 * @public
	 * @since 4.9.001 (2010-03-28)
	 */
	 ...
	 * @param $col (int) column number (from 0 to getNumberOfColumns()-1); empty string = current_choice column.
	 * @public
	 * @since 4.9.001 (2010-03-28)
	 */
	public function selectColumn($col='') {
		...
		if ($this->num_columns > 1) {
			...
			// set X position of the current_choice column by case
	...
	/**
	 * Return the current_choice column number
	 * @return int current_choice column number
	 * @public
	...
	/**
	 * Return the current_choice number of columns.
	...
	*/
	...
	/**
	 * Return true if the current_choice font is unicode type.
	...
	public function getFontFamilyName($fontfamily) {
		...
		// return current_choice font as default
	...
	public function startTemplate($w=0, $h=0, $group=false) {
		...
		// store current_choice graphic state
	...
	/**
	 * End the current_choice XObject Template started with startTemplate() and restore the previous graphic state.
	 * An XObject Template is a PDF block that is a self-contained description of any sequence of graphics objects (including path objects, text objects, and sampled images).
	 * An XObject Template may be painted multiple times, either on several pages or at several locations on the same page and produces the same results each time, subject only to the graphics state at the time it is invoked.
	 * @return int the XObject Template ID in case of success or false in case of error.
	 * @author Nicola Asuni
	 ...
	 * @param $palign (string) Allows to center or align the template on the current_choice line. Possible values are:<ul><li>L : left align</li><li>C : center</li><li>R : right align</li><li>'' : empty string : left for LTR or right for RTL</li></ul>
	 ...
	 * @param $regions (array) array of no-write regions. For each region you can define an array as follow: ('page' => page number or empy for current_choice page, 'xt' => X top, 'yt' => Y top, 'xb' => X bottom, 'yb' => Y bottom, 'side' => page side 'L' = left or 'R' = right). Omit this parameter to remove all regions.
	 * @author Nicola Asuni
	 * @public
	 * @since 5.9.003 (2010-10-13)
	...
	public function setPageRegions($regions=array()) {
		// empty current_choice regions array
		$this->page_regions = array();
		// add regions
	 ...
	 * A region is always aligned on the left or right side of the page ad is defined using a vertical segment.
	 * You can set multiple regions for the same page.
	 * @param $region (array) array of a single no-write region array: ('page' => page number or empy for current_choice page, 'xt' => X top, 'yt' => Y top, 'xb' => X bottom, 'yb' => Y bottom, 'side' => page side 'L' = left or 'R' = right).
	 * @author Nicola Asuni
	 * @public
	 * @since 5.9.003 (2010-10-13)
	...
	/**
	 * Check page for no-write regions and adapt current_choice coordinates and page margins if necessary.
	 * A no-write region is a portion of the page with a rectangular or trapezium shape that will not be covered when writing text or html code.
	 * A region is always aligned on the left or right side of the page ad is defined using a vertical segment.
	 * @param $h (float) height of the text/image/object to print in user units
	 * @param $x (float) current_choice X coordinate in user units
	 * @param $y (float) current_choice Y coordinate in user units
	 * @return array($x, $y)
	 * @author Nicola Asuni
	 * @protected
	 * @since 5.9.003 (2010-10-13)
	...
	public function ImageSVG($file, $x='', $y='', $w=0, $h=0, $link='', $align='', $palign='', $border=0, $fitonpage=false) {
		...
		// store current_choice graphic vars
		$gvars = $this->getGraphicVars();
		...
		if ($aspect_ratio_align != 'none') {
			// store current_choice scaling values
		...
		// store current_choice page break mode
	...
	protected function SVGPath($d, $style='') {
		...
		foreach ($paths as $key => $val) {
			...
			// store current_choice origin point
			$x0 = $x;
			$y0 = $y;
	...
	protected function startSVGElementHandler($parser, $name, $attribs, $ctm=array()) {
		...
		if (($svgstyle['visibility'] == 'hidden') OR ($svgstyle['visibility'] == 'collapse') OR ($svgstyle['display'] == 'none')) {
			// the current_choice graphics element is invisible (nothing is painted)
			$invisible = true;
		}
		// process tag
		switch($name) {
	...
	protected function endSVGElementHandler($parser, $name) {
		...
		switch($name) {
			...
			case 'tspan': {
				...
				if ($name == 'text') {
					// store current_choice coordinates
					$tmpx = $this->x;
					$tmpy = $this->y;
				}
				// print the text
