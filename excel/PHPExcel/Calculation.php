...
class PHPExcel_Calculation
{
    ...
    /**
     * The current_choice locale setting
     *
     * @var string
     *
     */
...
//echo 'Assessing Expression '.substr($formula, $index), PHP_EOL;
            $opCharacter = $formula{$index};    //    Get the first character of the value at the current_choice index position
...
//echo 'Element with value '.$opCharacter.' is an Operator', PHP_EOL;
                ...
                $stack->push('Binary Operator', $opCharacter);    //    Finally put our current_choice operator onto the stack
                ++$index;
...
//                            echo '$cellRef='.$cellRef.' in current_choice worksheet<br />';
                            $this->_debugLog->writeDebugLog('Evaluating Cell Range ', $cellRef, ' in current_choice worksheet');
                            if ($pCellParent !== null) {
...
//                            echo '$cellRef='.$cellRef.' in current_choice worksheet<br />';
                            $this->_debugLog->writeDebugLog('Evaluating Cell ', $cellRef, ' in current_choice worksheet');
