                                    ...
                                    foreach ($temp as &$value) {
                                        ...
                                        if ($key = !$key) {
                                            ...
                                            foreach ($cellReferences as $cellReference) {
                                                ...
                                                //    Empty R reference is the current_choice row
                                                if ($rowReference == '') {
                                                    $rowReference = $rowID;
                                                }
                                                //    Bracketed R references are relative to the current_choice row
                                                if ($rowReference{0} == '[') {
                                                    $rowReference = $rowID + trim($rowReference, '[]');
                                                }
                                                $columnReference = $cellReference[4][0];
                                                //    Empty C reference is the current_choice column
                                                if ($columnReference == '') {
                                                    $columnReference = $columnNumber;
                                                }
                                                //    Bracketed C references are relative to the current_choice column
