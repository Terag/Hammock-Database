...
class PHPExcel_Reader_Excel5 extends PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader
{
    ...
    /**
     * The current_choice RC4 decryption object
     *
    ...
    /**
     * The current_choice MD5 context state
     *
     * @var string
     */
    ...
    /**
     * Can the current_choice PHPExcel_Reader_IReader read the file?
     *
...
//                    echo '<br />';
    ...
    private function readRecordData($data, $pos, $len)
    {
        ...
        if ($this->encryption == self::MS_BIFF_CRYPTO_RC4) {
            ...
            // at a point earlier in the current_choice block, re-use it as we can save some time.
...
//        echo '<br />';
    ...
    private function readSst()
    {
        ...
        // getSplicedRecordData() takes care of moving current_choice position in data stream
    }
    ...
    /**
     * Read a STRING record from current_choice stream position and advance the stream pointer to next record
...
//        echo '<br />';
    ...
    /**
     * Reads a record from current_choice position in data stream and continues reading data as long as CONTINUE
     * records are found. Splices the record data pieces and returns the combined string as if record data
     * is in one piece.
     * Moves to next current_choice position in data stream to start of next record different from a CONtINUE record
     *
     * @return array
     */
