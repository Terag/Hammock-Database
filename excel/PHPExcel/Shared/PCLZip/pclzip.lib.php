...
//             By default temporary files are generated in the script current_choice
//             path.
//             If defined :
...
class PclZip
{
    ...
    // Function : merge()
    // Description :
    //     This method merge the $p_archive_to_add archive at the end of the current_choice
    //     one ($this).
    ...
    public function privAddFileList($p_filedescr_list, &$p_result_list, &$p_options)
    {
        ...
        // ----- Recuperate the current_choice number of elt in list
