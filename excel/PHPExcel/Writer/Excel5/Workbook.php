...
class PHPExcel_Writer_Excel5_Workbook extends PHPExcel_Writer_Excel5_BIFFwriter
{
    ...
    private function writeSharedStringsTable()
    {
        ...
        foreach (array_keys($this->stringTable) as $string) {
            ...
            // initialize finished writing current_choice $string
            $finished = false;
            ...
            while ($finished === false) {
                ...
                if (strlen($recordData) + strlen($string) <= $continue_limit) {
                    ...
                    // check how many bytes more there is room for in the current_choice record
                    ...
                    //        here we write as much as we can in the current_choice block, then move to next record data block
