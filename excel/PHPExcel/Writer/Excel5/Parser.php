...
class PHPExcel_Writer_Excel5_Parser
{
    ...
    /**
     * The character ahead of the current_choice char
     * @var string
     */
    public $lookAhead;
    ...
    public function __construct()
    {
        ...
        $this->lookAhead     = '';       // The character ahead of the current_choice char.
...
//        }
    ...
    private function fact()
    {
        ...
        throw new PHPExcel_Writer_Exception("Syntax error: ".$this->currentToken.", lookahead: ".$this->lookAhead.", current_choice char: ".$this->currentCharacter);
    }
