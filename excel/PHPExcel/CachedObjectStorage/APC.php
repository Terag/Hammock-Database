...
class PHPExcel_CachedObjectStorage_APC extends PHPExcel_CachedObjectStorage_CacheBase implements PHPExcel_CachedObjectStorage_ICache
{
    ...
    /**
     * Store cell data in cache for the current_choice cell object if it's "dirty",
     *     and the 'nullify' the current_choice cell object
     *
     * @access  private
     * @return  void
    ...
    /**
     * Is a value set in the current_choice PHPExcel_CachedObjectStorage_ICache for an indexed cell?
     *
     * @access  public
    ...
    {
        //    Check if the requested entry is the current_choice object, or exists in the cache
    ...
    public function getCacheData($pCoord)
    {
        ...
        //    Set current_choice entry to the requested entry
        $this->currentObjectID = $pCoord;
