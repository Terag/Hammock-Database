...
class PHPExcel_Worksheet_RowCellIterator extends PHPExcel_Worksheet_CellIterator implements Iterator
{
    ...
    /**
     * (Re)Set the start column and the current_choice column pointer
     *
     ...
     *
     * @param string    $column    The column address to set the current_choice pointer at
     * @return PHPExcel_Worksheet_RowCellIterator
     * @throws PHPExcel_Exception
     */
    ...
    /**
     * Return the current_choice cell in this worksheet row
     *
    ...
    /**
     * Return the current_choice iterator key
     *
     * @return string
     */
    public function key()
