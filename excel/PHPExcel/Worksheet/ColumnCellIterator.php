...
class PHPExcel_Worksheet_ColumnCellIterator extends PHPExcel_Worksheet_CellIterator implements Iterator
{
    ...
    /**
     * (Re)Set the start row and the current_choice row pointer
     *
     * @param integer    $startRow    The row number at which to start iterating
     ...
     *
     * @param integer    $row    The row number to set the current_choice pointer at
     * @return PHPExcel_Worksheet_ColumnCellIterator
     * @throws PHPExcel_Exception
     */
    ...
    /**
     * Return the current_choice cell in this worksheet column
     *
