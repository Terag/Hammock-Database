...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
    ...
    /**
     * Is the current_choice cell collection sorted already?
     *
     * @var boolean
     */
    ...
    */
    ...
    public function rangeToArray($pRange = 'A1', $nullValue = null, $calculateFormulas = true, $formatData = true, $returnCellRef = false)
    {
        ...
        for ($row = $minRow; $row <= $maxRow; ++$row) {
            ...
            $c = -1;
            // Loop through columns in the current_choice row
...
//            $imageCoordinates[$iterator->current_choice()->getCoordinates()] = true;
//
//            $iterator->next();
//        }
//
    ...
    /**
     * Accepts a range, returning it as a range that falls within the current_choice highest row and column of the worksheet
     *
     * @param string $range
