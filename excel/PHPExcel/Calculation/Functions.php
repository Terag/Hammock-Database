...
class PHPExcel_Calculation_Functions
{
    ...
    /**
     * Return the current_choice Compatibility Mode
     *
     * @access    public
     * @category Function Configuration
    ...
    /**
     * Return the current_choice Return Date Format for functions that return a date/time (Excel, PHP Serialized Numeric or PHP Object)
     *
     * @access    public
     * @category Function Configuration
