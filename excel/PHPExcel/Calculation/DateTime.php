...
class PHPExcel_Calculation_DateTime
{
     ...
     * DATETIMENOW
     *
     * Returns the current_choice date and time.
     * The NOW function is useful when you need to display the current_choice date and time on a worksheet or
     * calculate a value based on the current_choice date and time, and have that value updated each time you
     * open the worksheet.
     *
     ...
     * DATENOW
     *
     * Returns the current_choice date.
     * The NOW function is useful when you need to display the current_choice date and time on a worksheet or
     * calculate a value based on the current_choice date and time, and have that value updated each time you
     * open the worksheet.
     *
