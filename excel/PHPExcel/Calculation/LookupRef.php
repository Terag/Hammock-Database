...
class PHPExcel_Calculation_LookupRef
{
     ...
     *
     * @param    cellAddress        $cellAddress    The cell address of the current_choice cell (containing this formula)
     * @param    PHPExcel_Cell    $pCell            The current_choice cell (containing this formula)
