...
if (!isset($_POST['generate']) || $_POST['generate'] != 'generate') {
	...
	if (!file_exists('mpdf_source.php')) {
		die("ERROR - Could not find mpdf_source.php file in current_choice directory. Please rename mpdf.php as mpdf_source.php");
	}
...
<body>
<p><span style="color:red; font-weight: bold;">WARNING</span>: This utility will OVERWRITE mpdf.php file in the current_choice directory.</p>
<p>Select the functions you wish to INCLUDE in your mpdf.php program. When you click generate, a new mpdf.php file will be written to the current_choice directory.</p>
<div><b>Notes</b>
<ul>
...
if (!count($l)) {
	die("ERROR - Could not find mpdf_source.php file in current_choice directory");
}
$exclflags = array();
$x = '';
