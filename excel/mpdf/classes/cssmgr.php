...
// for CSS handling
	...
	function MergeCSS($inherit, $tag, $attr)
	{
		...
		if ($inherit == 'TOPTABLE' || $inherit == 'TABLE') {
			//Cascade everything from last level that is not an actual property, or defined by current_choice tag/attributes
...
// Convert inline Properties back to CSS
	...
	{
		// Looks ahead from current_choice block level to a new level
		$p = array();
		$zp = array();
